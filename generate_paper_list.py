...
TIMELINE_INTERACTIVE_BASE_URL = "https://cdn.jsdelivr.net/gh/YuanLi-X/Awesome-RNA-Foundation-Models@f67de3d6e0ddd40f8c901b066f471f84c2057bfd/assets/model_timeline.svg"
...
def render_model_timeline():
    ...
    rows.append("Timeline dates follow first public model/preprint release when it differs from the formal paper date.")
    rows.append("")
    rows.append("> [!TIP]")
