...
- [Detailed Tables](#detailed-tables) — Detailed tables for all 65 model entries, 12 benchmarks, 3 surveys
...
Timeline of 65 confirmed RNA sequence foundation model entries, generated from `data/papers.yaml` whenever confirmed metadata is refreshed.
...
**Interactive view:** [open the SVG timeline](https://raw.githack.com/COLA-Laboratory/Awesome-RNA-Foundation-Models/main/assets/model_timeline-3e9e5f02b6fb.svg) to click model labels and source papers.

[![RNA foundation model timeline](assets/model_timeline-3e9e5f02b6fb.svg)](https://raw.githack.com/COLA-Laboratory/Awesome-RNA-Foundation-Models/main/assets/model_timeline-3e9e5f02b6fb.svg)
...
<details open>
<summary><b>Core RNA Foundation Models (31)</b></summary>
...
- **miRstring** — [miRstring: An RNA language model enables mature miRNA decoding and artificial small RNA design across species](https://doi.org/10.64898/2026.09.17.752258) (2026.09, preprint) [![abs](https://img.shields.io/badge/abs-2026.09-b31b1b.svg)](https://doi.org/10.64898/2026.09.17.752258) [![preprint](https://img.shields.io/badge/preprint-gray.svg)](https://doi.org/10.64898/2026.09.17.752258)

  > Abstract Introduction MicroRNAs (miRNAs) are processed from structured precursors and subsequently loaded into Argonaute proteins to repress target mRNAs.

- **GPT** — [What a nano-GPT can (not) tell us about spoken language](https://doi.org/10.1075/ijcl.24172.pac) (2026.09) [![abs](https://img.shields.io/badge/abs-2026.09-b31b1b.svg)](https://doi.org/10.1075/ijcl.24172.pac)

  > Abstract After the launch of ChatGPT in autumn 2022, a lot of research has focussed on the quality and near-naturalness Large Language Model-based tools present in the texts they produce.
...
- **RNA** — [Conditional Generation and Inpainting of Non-Coding RNA Sequences with Masked Discrete Diffusion](https://doi.org/10.64898/2026.09.17.752279) (2026.09, preprint) [![abs](https://img.shields.io/badge/abs-2026.09-b31b1b.svg)](https://doi.org/10.64898/2026.09.17.752279) [![preprint](https://img.shields.io/badge/preprint-gray.svg)](https://doi.org/10.64898/2026.09.17.752279)

  > Abstract Designing functional non-coding RNA (ncRNA) is fundamental to synthetic biology and RNA therapeutics, yet generative modelling for ncRNA has received far less attention than protein design.
...
<details open>
<summary><b>Specialized RNA Foundation Models (24)</b></summary>
...
<details open>
<summary><b>Encoder-only (BERT-family) (39)</b></summary>
...
<details open>
<summary><b>Decoder-only (GPT-family) (10)</b></summary>
...
<details open>
<summary><b>Single Nucleotide Token (SNT) (40)</b></summary>
...
| <nobr>**miRstring**</nobr> | <nobr>Core RNA Foundation Models</nobr> | <nobr>[Paper](https://doi.org/10.64898/2026.09.17.752258)</nobr> | - | <nobr>2026.09<br><sub>preprint</sub></nobr> | <nobr>Decoder-only</nobr> | - | - | <nobr>SNT</nobr> |
...
| <nobr>**GPT**</nobr> | <nobr>Core RNA Foundation Models</nobr> | <nobr>[Paper](https://doi.org/10.1075/ijcl.24172.pac)</nobr> | - | <nobr>2026.09</nobr> | <nobr>Decoder-only</nobr> | - | - | <nobr>SNT</nobr> |
| <nobr>**RNA**</nobr> | <nobr>Core RNA Foundation Models</nobr> | <nobr>[Paper](https://doi.org/10.64898/2026.09.17.752279)</nobr> | - | <nobr>2026.09<br><sub>preprint</sub></nobr> | <nobr>Specialized</nobr> | - | - | <nobr>SNT</nobr> |
